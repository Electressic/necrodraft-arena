...
public class MusicManager : MonoBehaviour
{
    ...
    void Awake()
    {
        // Singleton pattern - only one MusicManager should exist
    ...
    private void SetupAudioSource()
    {
        ...
        musicAudioSource.volume = 0f; // Start silent for fade-in
    }
    
    private void LoadVolumeFromSettings()
    {
        // Load music volume from PlayerPrefs (same key as SettingsManager)
    ...
    // Called by SettingsManager when music volume changes
