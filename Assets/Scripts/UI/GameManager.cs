...
public class GameManager : MonoBehaviour
{
    ...
    public TMPro.TextMeshProUGUI actText;           // NEW: Display current act
    public TMPro.TextMeshProUGUI progressText;      // NEW: Display progression info
    ...
    string GetProgressionInfo(int wave)
    {
        ...
        // Build progression text with key milestones
        string info = $"Minions: {currentMinions}/{maxMinions}";
        
        // Add next unlock info
        if (wave < 17) // Still unlocking minions
        {
    ...
    // Public method that CombatManager can call to refresh the UI
